    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          ردیابی فرآیند استخدام شما از شروع تا پایان
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ابزارهای کامل طراحی شده تا هر گام از فرآیند استخدام شما را بهینه تر کند.
          </p>
        </div>
                ...
                <div className="mt-6 bg-emerald-600 rounded-xl p-6 text-white">
                  <div className="bg-white rounded-lg p-4 text-left">
                    ...
                    <p className="text-xs text-gray-600 mb-2">
                      رهبری توسعه و فرآیند، از کشف، ایده سازی، prototyping، و توسعه نهایی UI &.
                    </p>
